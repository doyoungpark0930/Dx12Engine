...
void Renderer::OnInit()
{
	...
	// Create descriptor heaps.
	{
		...
		cbvHeapDesc.NumDescriptors = ObjectsNum;
...
void Renderer::OnUpdate()
{
	...
	m_Objects[0].m_constantBufferData.offset.x += translationSpeed;
	if (m_Objects[0].m_constantBufferData.offset.x > offsetBounds)
	{
...
void Renderer::PopulateCommandList()
{
	...
	// Record commands.
	const float clearColor[] = { 1.0f, 0.71f, 0.76f, 1.0f };
